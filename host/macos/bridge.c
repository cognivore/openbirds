...
extern kk_ref_t kk_ttf_new_font_registry(kk_context_t* _ctx);
extern kk_unit_t kk_ttf_register(kk_ref_t r, kk_string_t name,
...
static kk_ref_t borrow_fonts(kk_context_t* ctx) {
    if (!g_fonts_init) {
        g_fonts      = kk_ttf_new_font_registry(ctx);
        g_fonts_init = true;
    }
